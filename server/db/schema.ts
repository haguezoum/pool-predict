...
export const appUsers = poolPredict.table(
  ...
  (table) => [uniqueIndex('app_users_intra_user_id_key').on(table.intraUserId)]
)
...
export const poolRefs = poolPredict.table(
  ...
  (table) => [uniqueIndex('pool_refs_external_ref_key').on(table.externalRef)]
)
...
export const examRefs = poolPredict.table(
  ...
  (table) => [uniqueIndex('exam_refs_pool_code_key').on(table.poolId, table.code)]
)
